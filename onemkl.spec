...
Patch1: 0001-Fix-FindCBLAS-for-OpenBLAS.patch
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622324993
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/haswell/libonemkl_blas_mklcpu.so
...
/usr/lib64/haswell/libonemkl_blas_mklcpu.so.0
